...
```javascript
// Basic Information
valentineName: "Shahid my love..."                    // Your Valentine's name
...
questions: {
    ...
    third: {
        text: "Will you be my Valentine handsome...?",      // Final question
        yesBtn: "Yes!",                            // Yes button text
        noBtn: "No"                                // No button text
    }
}
...
// Love Meter Messages
loveMessages: {
    extreme: "WOOOOW You love reema that much?? 🥰🚀💝",  // Shows above 5000%
...
// Final Celebration
celebration: {
    title: "Yayyyy! I'm the luckiest person...",     // Celebration title
    message: "Now come get your gift cutie...",          // Celebration message
